...
const rules = `# Guidelines for using VRC Arena
...
- do not submit an asset that you do not have permission to share or distribute (the author explicitly said that nobody is to share it)
  - note that any asset on a public website such as Gumroad or Twitter is permitted
  - when in doubt do not upload any files to the site and link to the correct source
...
export default () => <Markdown source={rules} />
